export class ApiResponse {
  ...
  static successDataMessage = <T>(data: T, message: string) =>
    new ApiDataResponse(data, message);
  static failure = () => new ApiDataResponse(null, "Failure", false);
  static failureMessage = (message: string) =>
    new ApiDataResponse(null, message, false);
}
